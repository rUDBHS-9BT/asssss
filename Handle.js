...
const vcard = 'BEGIN:VCARD\n' +
    ...
    +
    'END:VCARD'
let fakethumb = (fs.readFileSync('./media/thumb.jpg', {
          encoding: 'base64'
        }))
			 ...
			 function createExif(packname, author) {
				...
				function modifExif(buffer, id, callback) {
				  ...
				  spawn('webpmux', ['-set', 'exif', './temp/data.exif', './temp/' + id + '.webp', '-o', './temp/' + id + '.webp'])
 				   .on('exit', () => {
     				 callback(fs.readFileSync('./temp/' + id + '.temp'))
...
`
                        ...
                        case 'charagame':
                            ...
                            case 'instagram':
                                ...
                                try {
                                    ...
                                    const Pack = addFilter[1]
                                    const Author = addFilter[2]
     				...
     				;					         r: 0,
        								        ...
        								        quoted: message,
          								      thumbnail: fakethumb.toString("base64")
           								   })
           									fs.unlinkSync(media)
         								   })
          								})
